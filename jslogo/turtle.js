...
function CanvasTurtle(canvas_ctx, turtle_ctx, width, height) {
  ...
  function parseColor(color) {
	switch(color)
	{
		case 'czarny':					color = 'black';		break;
		case 'niebieski':				color = 'blue';			break;
		case 'zielony':					color = 'green';		break;
		case 'cyjan':					color = 'cyan';			break;
		case 'czerwony':				color = 'red';			break;
		case '\u017C\u00F3\u0142ty':	color = 'yellow';		break;
		case 'bia\u0142y':				color = 'white';		break;
		case 'br\u0105zowy':			color = 'brown';		break;
		case 'zielony':					color = 'green';		break;
		case '\u0142ososiowy':			color = 'salmon';		break;
		case 'fioletowy':				color = 'purple';		break;
		case 'pomara\u0144czowy':		color = 'orange';		break;
		case 'szary':					color = 'gray';			break;	
	}
  ...
  this.setstate = function (state) {
    if ((! state) || ! state.isturtlestate) {
      throw new Error("Pr\u00F3bowano przywr\u00F3ci\u0107 stan kt\u00F3ry nie jest stanem \u017C\u00F3\u0142wia");
    }
    this.penup();
    this.hideturtle();
